...
**Report Question 2c:** What could be one real life use of this process?
...
**Report Question 2d:** What happens to the value of our constraint when we bring one line to the other?
...
## 4. Bonus (10 Points): Augmented Reality
<div class="row justify-content-md-center">
    <div class="col-sm-12 mt-6 mt-md-6">
        {% include video.liquid path="assets/img/hom_test.webm" title="Live Augmented Reality" class="img-fluid rounded z-depth-1" autoplay=true controls=false loop=true %}
    </div>
</div>
...
- **Project an Image:** Warp an image (or images) onto the tracked surface so that, even as the camera moves, the projection remains fixed to the surface.
- **Be Creative!**

**Deliverables:**

- A video demo showing the original and transformed (projected) images.
- **Report Question 2b:** Briefly explain one real-life application of this process.
