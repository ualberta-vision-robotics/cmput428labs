...
<div class="row justify-content-md-center">
    <div class="col-sm-10 mt-6 mt-md-6">
        {% include figure.liquid loading="eager" path="assets/img/homogeneous_house.png" title="house subplots" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
- Create functions that create translation, rotation, scale and shear transformation matricies using the equations provided above. Apply the following transformations to our provided house point cloud and recreate the above figure. __You will lose marks if your house is not at the same coordinates as our figure.__
  1. Original Point Cloud
  2. Translate by (100, 100)
  3. Rotate by +90 degrees
  4. Rotate by 180 degrees about centroid
  5. Scale by (0.5, -1)
  6. Shear by (0.2, 0)
...
**Deliverables:**
- Display the image in your report. Describe how you created this image.
- Save your image to include with your submission.
...
<div class="row justify-content-md-center">
    <div class="col-sm-6 mt-6 mt-md-6">
        {% include figure.liquid loading="eager" path="assets/img/shrek.png" title="shrek to point cloud" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Shrek asset.
...
```python
def get_point_cloud(image, threshold = 150, width=200):
    if len(image.shape):
        image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
    dimx = width
    dimy = int(image.shape[1]/image.shape[0]*dimx)
