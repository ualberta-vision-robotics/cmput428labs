...
description:
permalink: /2dgeometry_HIDDEN # changed to show version w/o qns for now
img: 
importance: 1
...
- [Use the code on this page]({{"/get_pointcloud" | relative_url}}){:target="_blank"} to generate point clouds of your own assets. Search up coloring page versions of your favorite characters and load them in.
...
- **Make sure to find and use your own assets for this question!**
...
- You can use the keyboard images for testing - **however, for submission, make sure you use your own images!**
