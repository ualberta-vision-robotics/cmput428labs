...
<div class="row justify-content-md-center">
    <div class="col-sm-12 mt-6 mt-md-6">
        {% include video.liquid path="assets/img/ar_homography_loop.webm" title="Imaginal disk in bladerunner" class="img-fluid rounded z-depth-1" autoplay=true controls=false loop=True%}
    </div>
</div>
<div class="caption">
...
## 4. Bonus (30) Live - Augmented Reality (Insert competition stuff here)
