...
- <strong><font color='DarkViolet'>Grad students: choose two of the following three questions to obtain the remaining 50 marks.</font></strong>
  - Or you may complete both methods in Question 4 to obtain the remaining 50 marks.
...
**Deliverables:**
- Save the videos to include with your submission. Ensure they are less than 10 mb.
...
**Deliverables:**
- Save the videos to include in your submission. Ensure they are less than 10 mb.

**Report Question 3:** What is the difference between forward and inverse Lukas-Kanade?
...
#### d. Bonus (5) Incremental Updating (`update`)
