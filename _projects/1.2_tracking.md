...
__Lab Introduction Slides:__ [found here](https://drive.google.com/file/d/1D-yO3cDUqt22-3m66YvzXtZpgFaLwvyQ/view?usp=drive_link).
...
The link to the prelab questions [can be found here](https://docs.google.com/document/d/1SClaef6-be-GfVvL74HB6rySPTkvTXSg7FGxskskmRY/edit?usp=drive_link). You will need your University of Alberta email for access; they are also available under the Canvas assignment. __Due Tuesday, January 20 at 5pm.__ 
...
Code template: [can be found here.](https://drive.google.com/file/d/187KHFPiJQaTmgK9GpcCBwp_XxaG2JtgE/view?usp=drive_link)

Report template (same document as 1.1): [can be found here.](https://docs.google.com/document/d/1LHkyROduTG_6_dg-OD8tO0BjeztdJKf26XDmro4vFr8/edit?usp=drive_link)
...
## Important
- Undergraduate students: choose __one of the following two questions__ to complete for this lab to obtain the remaining 40 marks. The other question is a bonus.

- <strong><font color='DarkViolet'>Grad students: complete the following two questions to obtain the remaining 60 marks.</font></strong>

---

## 2. Pyramidal 2-DoF SSD Tracker

See [slides 57-64 of this slide deck](https://ugweb.cs.ualberta.ca/~vis/courses/CompVis/lectures24/Lec04OptFlowMot.pdf).
...
To do this, you may implement either the _additive_ or _inverse compositional_ version of the Lukas-Kanade algorithm. We recommend the additive algorithm as it is simpler. Information about the difference between these can be found in the Baker and Matthews paper and in the lecture slides. 

- See [OpenCV documentation on transformations](https://docs.opencv.org/4.x/da/d6e/tutorial_py_geometric_transformations.html).
- See [Baker and Matthews Paper on Lukas-Kanade for both algorithms](https://www.ncorr.com/download/publications/bakerunify.pdf).
...
- See [pages 43-44 of these slides](https://ugweb.cs.ualberta.ca/~vis/courses/CompVis/lectures24/lec05bRegTrack2.pdf) for more on the inverse-compositional algorithm.
...
1. **Accuracy**: Tracking performance will be quantitatively evaluated.
    ...
    <!-- - The tracking error will be computed using the following formula: 
        ```python
...
- Total marks for this lab is __100__ for undergraduate students and __120__ for graduate students. Your lab assignment grade with bonus marks is capped at __110%__. Report bonus marks will be applied to the report grade, capped at 110%.
