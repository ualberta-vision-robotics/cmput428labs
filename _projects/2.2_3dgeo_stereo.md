...
- Create an animation using transformations and projections you've learned in this course thus far.
- First, create the animation in 3D and then project it to 2D.
...
- The cover video for this page was created in this manner.
