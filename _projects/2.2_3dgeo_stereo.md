...
<div class="row justify-content-md-center">
    <div class="col-sm-8 mt-6 mt-md-6">
        {% include video.liquid path="assets/img/cubes2.webm" title="Velocity : Design : Comfort" class="img-fluid rounded z-depth-1" autoplay=true controls=false loop=true muted=true %}
    </div>
</div>
<div class="caption">
