...
description:
permalink: /3dgeometry_HIDDEN # changed to show version w/o qns for now
img:
importance: 2
...
__Lab Introduction Slides:__ [available here]()
...
- Then, use ([this table](https://en.wikipedia.org/wiki/Image_sensor_format)) to find the crop fector and sensor width in mm for your phone. If you cannot find your exact optical format, use whatever is closest in the table.
